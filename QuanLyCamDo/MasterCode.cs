...
namespace QuanLyCamDo
{
    class MasterCode
    {
        ...
        public string WCF_CallAPI(string domain, List<ParameterAPI_DAO> parameters, Dictionary<string, string> headers, string body)
        {
            try
            {
                using (var wc = new WebClient())
                {
                    ...
                    {
                        domain = domain + "?";
                        foreach (ParameterAPI_DAO param in parameters)
                        {
                            domain += param.parameterName + "=" + param.parameterValue + "&";
                        }
